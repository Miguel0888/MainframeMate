...
public final class FormFilterPanel extends JPanel {
    ...
    public FormFilterPanel() {
        ...
        baseFormBox = new JComboBox<OptionItem>(new OptionItem[] {
                ...
                new OptionItem("ATAB", "ATAB â€“ Schulung"),
                new OptionItem("APZD", "APZD â€“ F13Z/F15Z Buchungsdaten (Produktion)"),
                new OptionItem("ATZD", "ATZD â€“ F13Z/F15Z Buchungsdaten (Test)"),
                new OptionItem("APAB", "APAB â€“ ZABAK (Basis)"),
                new OptionItem("CUSTOM", "Custom â€“ Freier Form-Wert")
        });
